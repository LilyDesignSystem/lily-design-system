...
- Renders as `<input type="text">` with class `kypros-national-passport-number-input`
...
- [ ] Renders <input> element with class="kypros-national-passport-number-input"
...
- CSS class: .kypros-national-passport-number-input in css-style-sheet-template.css
- Companion: KyprosNationalPassportNumberView
