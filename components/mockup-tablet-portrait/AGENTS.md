...
- Component: mockup-tablet-portrait
- PascalCase: MockupTabletPortrait
...
- [ ] Renders <div> element with class="mockup-tablet-portrait"
- [ ] Has role="img"
...
- CSS class: .mockup-tablet-portrait in css-style-sheet-template.css
- HTML headless: lily-design-system-html-headless/components/mockup-tablet-portrait.html
