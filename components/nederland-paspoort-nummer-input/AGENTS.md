...
- Renders as `<input type="text">` with class `nederland-paspoort-nummer-input`
...
- [ ] Renders <input> element with class="nederland-paspoort-nummer-input"
...
- CSS class: .nederland-paspoort-nummer-input in css-style-sheet-template.css
- Companion: NederlandPaspoortNummerView
