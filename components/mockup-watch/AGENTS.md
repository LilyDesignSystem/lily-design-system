...
- [ ] Renders <div> element with class="mockup-watch"
- [ ] Has role="img"
...
- CSS class: .mockup-watch in css-style-sheet-template.css
- HTML headless: lily-design-system-html-headless/components/mockup-watch.html
