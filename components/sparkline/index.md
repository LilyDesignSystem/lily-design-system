...
- Verify the component renders a `<span>` element with class `sparkline`
- Verify role="img"` -- identifies the container as a graphical image to assistive technologies
