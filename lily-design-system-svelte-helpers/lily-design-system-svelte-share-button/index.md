...
```ts
import ShareButton from "./lily-design-system-svelte-share-button/ShareButton.svelte";
// or via the barrel:
import { ShareButton, canShareNatively, type ShareTarget }
  from "./lily-design-system-svelte-share-button";
```
...
<script lang="ts">
  import ShareButton, { type ShareTarget }
    from "./lily-design-system-svelte-share-button/ShareButton.svelte";
...
`npx vitest run lily-design-system-svelte-share-button` from the catalog
