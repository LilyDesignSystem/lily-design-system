...
| Helper | Purpose |
| ------ | ------- |
| [`lily-design-system-svelte-theme-select`](../lily-design-system-svelte-theme-select/) | Pick a visual theme; dynamic CSS load + `data-theme` swap, optional persistence. |
