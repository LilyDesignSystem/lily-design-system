...
All six helpers are implemented with Svelte 5 source, tests, docs, and a
package manifest. This catalog *is* the canonical reference — every other
framework's helpers port from it (see [`AGENTS/helpers.md`](../../AGENTS/helpers.md)'s
"Svelte is canonical" rule); when catalogs disagree, this one wins.
