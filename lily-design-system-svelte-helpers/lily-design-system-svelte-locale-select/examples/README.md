...
- No CSS dependency — the select is headless. Consumers style the
  `locale-select`, `locale-select-button`, `locale-select-icon`,
  `locale-select-list`, and `locale-select-option` class hooks.
...
| File                                                        | Demonstrates                                                       |
|-------------------------------------------------------------|--------------------------------------------------------------------|
| [`basic.svelte`](./basic.svelte)                            | The default rendering, plus the `.locale-select-status` live region every consumer should ship. |
...
descriptive names matching `theme-select`'s convention:
