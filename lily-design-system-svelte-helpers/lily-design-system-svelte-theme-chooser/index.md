...
```ts
import ThemeChooser from "./lily-design-system-svelte-theme-chooser/ThemeChooser.svelte";
// or via the barrel:
...
```svelte
<script lang="ts">
  import ThemeChooser, { themeName } from "./lily-design-system-svelte-theme-chooser/ThemeChooser.svelte";
