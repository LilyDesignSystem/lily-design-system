...
```ts
import LocaleChooser from "./lily-design-system-svelte-locale-chooser/LocaleChooser.svelte";
```
...
import LocaleChooser, {
    ...
    type Props,
    type ChildArgs,
} from "./lily-design-system-svelte-locale-chooser";
```
...
<script lang="ts">
    import LocaleChooser, {
        bcp47LocaleTag,
        localeName,
    } from "./lily-design-system-svelte-locale-chooser/LocaleChooser.svelte";
