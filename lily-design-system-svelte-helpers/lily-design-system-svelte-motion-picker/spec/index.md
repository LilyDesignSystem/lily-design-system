...
icon (two pause bars, `viewBox="0 0 16 16"`; bundled, not a Unicode
character — reversed 2026-09-16, replaceable via `children`), and a
...
2026-09-16 from Unicode glyphs). It is additive:
