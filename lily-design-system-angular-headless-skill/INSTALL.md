...
This repository is a Claude Skill covering the Angular 22 headless component library for an AI coding agent.
...
```sh
git clone https://github.com/LilyDesignSystem/lily-design-system-angular-headless-skill.git
```
