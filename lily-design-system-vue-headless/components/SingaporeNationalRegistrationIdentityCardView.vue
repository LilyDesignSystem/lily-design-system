<script setup lang="ts">
    ...
    //
    // A headless display for Singapore's National Registration Identity Card Number / Foreign Identification Number (NRIC/FIN).
...
<template>
    <!-- SingaporeNationalRegistrationIdentityCardView.vue -->
    <span
