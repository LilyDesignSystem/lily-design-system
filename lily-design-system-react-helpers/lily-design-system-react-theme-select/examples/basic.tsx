...
/*
    ...
    The default markup is a <div class="theme-select"> holding an icon
    button (the half-circle glyph, U+25D1) that opens a
    <ul class="theme-select-list" role="listbox"> with one
    <li class="theme-select-option" role="option"> per slug.
    ...
    listbox. The <p className="theme-select-status"> below is the
...
import { ThemeSelect, themeName } from "../ThemeSelect";
