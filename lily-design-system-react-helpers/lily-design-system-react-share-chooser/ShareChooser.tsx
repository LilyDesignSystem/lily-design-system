...
export function ShareChooser({
    ...
    const listId = `share-chooser-${React.useId()}-list`;
    ...
    return (
        <div
            ref={rootRef}
            className={`share-chooser ${className}`.trim()}
            onBlur={onRootBlur}
            {...restProps}
        >
            <button
                ref={buttonRef}
                type="button"
                className="share-chooser-button"
                aria-label={label}
                aria-expanded={open}
            ...
            >
                {children ? (
                    ...
                    <span className="share-chooser-icon" aria-hidden="true">
            ...
            <ul
                ref={listRef}
                className="share-chooser-list"
                id={listId}
                hidden={!open}
                onKeyDown={onListKeyDown}
            >
                {targets.map((target) => (
                    <li className="share-chooser-list-item" key={target.id}>
                        ...
                        <a
                            className="share-chooser-target"
                ...
                {copyLabel ? (
                    <li className="share-chooser-list-item">
                        <button
                            type="button"
                            className="share-chooser-copy"
                            onClick={copyUrl}
                        >
                            {copyLabel}
                        </button>
            ...
            <p className="share-chooser-status" aria-live="polite">
                {status}
            </p>
        </div>
    );
