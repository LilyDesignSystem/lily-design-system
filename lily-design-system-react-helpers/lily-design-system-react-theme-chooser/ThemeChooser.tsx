...
export function ThemeChooser({
    ...
    const baseId = `theme-chooser-${React.useId()}`;
    ...
    return (
        <div
            ref={rootRef}
            className={`theme-chooser ${className}`.trim()}
            onBlur={onRootBlur}
            {...restProps}
        >
            ...
            >
                {children ? (
                    ...
                    <span className="theme-chooser-icon" aria-hidden="true">
