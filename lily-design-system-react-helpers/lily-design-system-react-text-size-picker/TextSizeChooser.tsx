 ...
 * in theme-chooser and `localeName` in locale-chooser. The word "default"
 * is never emitted.
 */
...
export function TextSizeChooser({
    ...
    const baseId = `text-size-chooser-${React.useId()}`;
    ...
    return (
        <div
            ref={rootRef}
            className={`text-size-chooser ${className}`.trim()}
            onBlur={onRootBlur}
            {...restProps}
        >
            ...
            <button
                ref={buttonRef}
                type="button"
                className="text-size-chooser-button"
                aria-label={label}
            ...
            >
                {children ? (
                    ...
                    <span className="text-size-chooser-icon" aria-hidden="true">
            ...
            <ul
                ref={listRef}
                className="text-size-chooser-list"
                id={listId}
                role="listbox"
                aria-label={label}
            ...
            >
                {sizes.map((size, i) => (
                    <li
                        key={size}
                        className="text-size-chooser-option"
                        id={optionId(i)}
                        role="option"
...
export default TextSizeChooser;
