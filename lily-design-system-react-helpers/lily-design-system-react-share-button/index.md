...
```tsx
import ShareButton from "./lily-design-system-react-share-button/ShareButton";
// or via the barrel:
import { ShareButton, canShareNatively, type ShareTarget }
  from "./lily-design-system-react-share-button";
```
...
import ShareButton, { type ShareTarget }
  from "./lily-design-system-react-share-button/ShareButton";
...
```tsx
<ShareButton label="Share" targets={targets}>
...
`npx vitest run lily-design-system-react-share-button` from the catalog
