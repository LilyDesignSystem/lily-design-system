# AGENTS / testing — LocaleSelect

Test specifics for the React `LocaleSelect` helper. Read
...
```bash
cd lily-design-system-react-helpers/lily-design-system-react-locale-select
pnpm vitest run
```
