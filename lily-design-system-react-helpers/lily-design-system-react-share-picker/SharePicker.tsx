...
export function SharePicker({
    ...
    return (
        <div
            ref={rootRef}
            className={`share-picker ${className}`.trim()}
            onBlur={onRootBlur}
            {...restProps}
        >
            <button
            ...
            >
                {targets.map((target) => (
                    <li className="share-picker-list-item" key={target.id}>
                ...
                {copyLabel ? (
                    <li className="share-picker-list-item">
                        <button
                            type="button"
                            className="share-picker-copy"
                            onClick={copyUrl}
                        >
                            {copyLabel}
                        </button>
            ...
            <p className="share-picker-status" aria-live="polite">
                {status}
            </p>
        </div>
    );
