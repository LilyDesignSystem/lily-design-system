...
`lily-design-system-react-theme-chooser`. Each file is a runnable
...
- Some CSS positions the dropdown. The control is an icon button that
  ...
  and the list `position: absolute`. See
  [`../docs/styling.md`](../docs/styling.md).

| #  | File                                                       | Demonstrates                              |
| -- | ---------------------------------------------------------- | ----------------------------------------- |
| 1  | [`basic.tsx`](./basic.tsx)                                 | Minimal three-theme chooser + the default status line. |
...
| 7  | [`multiple-choosers.tsx`](./multiple-choosers.tsx)           | Two selects in one page via `name`.       |
